...
- multipleSentencesConnected: Set TRUE when there is more than one sentence and they are meaningfully connected. Set FALSE for single sentences, isolated words, fragments, or lists.
crossSentenceDependency: Set TRUE only when the reader must connect meaning across TWO OR MORE sentences. Set FALSE for isolated words, fragments, lists, labels, or any single complete sentence.
